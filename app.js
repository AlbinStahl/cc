document.addEventListener("DOMContentLoaded", function() {
    ...
    squares.forEach(square => square.addEventListener('dragleaver', dragLeaver));
    ...
    function checkMove(checkCase, points){
        for(i=0;i<width*width;i++){
            switch(checkCase){
                case'threerow':
                    arrcase=[i, i+1, i+2];
                    arrNoGo=[6,7,1,5,22,23,30,31,38,39,46,47,54,55,62,63];
                    break;
                case'threecolumn':
                    arrcase=[i,i+width,i+width*2];
                    arrNoGo=[48,49,50,51,52,53,54,5,56,57,58,59,60,61,62,63];
                    break;
                default:
